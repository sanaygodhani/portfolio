...
const config = {
  ...
  stats: [
    ...
    { value: "$100K+", label: "Monthly Revenue Managed" },
  ...
  experience: [
    {
      ...
      role: "Trade Strategy & Sales Analyst",
      location: "Mumbai, Maharashtra",
      date: "Feb 2026 – Present",
      bullets: [
        "Engineered an immutable, audit-ready inventory ledger system (PostgreSQL, Zod, advisory locks) handling 5–15 transactions/week for a 5–6-person team, replacing manual paper-based reconciliation with automated, real-time calculations.",
        "Built a real-time P&L engine aggregating revenue, container costs, labor, and disposal fees, giving the team instant profitability visibility per transaction instead of end-of-day/manual tallying.",
        "Supported sourcing and pricing decisions for ~100 tons/month in metal volume (~$95K–$115K in monthly revenue) through continuous market monitoring (LME trends, supply/demand shifts), contributing to a team-wide effort to optimize purchasing timing and margins.",
        "Collaborated cross-functionally between trading and sales, supporting alignment between procurement and market demand as part of a small team driving consistent operational execution over a 6-month build-and-deploy period."
      ],
    },
    {
      company: "Nirmal Bang",
  ...
  projects: [
    {
      name: "Parlant: Intelligent French Learning Platform (Click Me)",
      description: "Built a FastAPI backend with custom sliding-window rate limiting and an asynchronous psycopg_pool for Supabase. Integrated the SM-2 spaced repetition algorithm for vocabulary schedules, and engineered a custom auth bridge for Supabase JWT credentials.",
      stack: ["FastAPI", "Python", "Supabase", "PostgreSQL"],
      link: "https://learnfrench.indrith.com"
    },
    {
      name: "ERP & CRM",
      description:
